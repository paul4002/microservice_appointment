...
public class NutritionistUpdatedEventTest {
	...
	private NutritionistUpdatedEvent event;
	...
	void setUp() {
		...
		nombre = "Carlos";
		apellido = "Ramírez";
		especialidad = NutritionistSpecialty.SPORTS_NUTRITION;
		licenciaProfesional = "LIC-2024-002";
		event = new NutritionistUpdatedEvent(nutricionistaId, nombre, apellido, especialidad, licenciaProfesional);
	}
	...
	void getEventName_ShouldReturnEventName() {
		// Arrange
		String expectedEventName = "citas-evaluaciones.nutricionista.actualizado";
